...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String KEY_KEYTAKEN         = "takenvalue";
...
// ############################## create methods ###################################### //
    ...
    public void createHistory(History history) {
        ...
        values.put(KEY_KEYTAKEN, history.getPillTakenValue());
    ...
    public List<History> getHistory() {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                h.setPillTakenValue(c.getString(c.getColumnIndex(KEY_KEYTAKEN)));
